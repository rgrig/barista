...
type element =
  ...
  | UTF8 of UTF8.t
  | MethodHandle of Reference.kind * u2
  | MethodType of u2
...
let check pool =
  ...
  let check_entry = function
    ...
    | MethodHandle (reference_kind, reference_index) ->
        ...
        | Reference.REF_invokeStatic, (Methodref _)
        | Reference.REF_invokeSpecial, (Methodref _)
